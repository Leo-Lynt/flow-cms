    ...
    <div v-else-if="flow" class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg border border-gray-200 p-6">
            <div class="flex items-start justify-between mb-4">
              <div class="flex-1">
                <div class="flex items-center gap-2 mb-3">
                  <h1 class="text-3xl font-bold text-gray-900">{{ flow.name }}</h1>
                  <Icon
            ...
            <div class="flex items-center gap-3 pt-6">
              ...
              <button
                ...
                class="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-50 flex items-center gap-2"
              >
          ...
          <div v-if="hasWarnings" class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div class="flex items-start">
              <Icon icon="lucide:alert-triangle" class="w-5 h-5 text-yellow-600 mt-0.5 mr-3 flex-shrink-0" />
              <div class="flex-1">
          ...
          <div v-if="flow.publicMetadata?.detailedDescription" class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <!-- Tags -->
          <div v-if="flow.publicMetadata?.tags && flow.publicMetadata.tags.length > 0" class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <!-- Fork Chain -->
          <div v-if="forkChainFlows.length > 0" class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div class="space-y-6">
          ...
          <!-- Related Flows -->
          <div v-if="relatedFlows.length > 0" class="bg-white rounded-lg border border-gray-200 p-6">
