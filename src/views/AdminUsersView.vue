...
function getRoleBadge(role) {
  const badges = {
    ...
    administrator: { color: 'bg-purple-100 text-purple-800', label: 'Administrador' }
  }
  ...
  <AppLayout>
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600">Gerencie usuários, roles e permissões</p>
      </div>
      ...
      <div v-if="stats" class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          <div class="flex items-center justify-between mb-2">
            ...
            <Icon icon="lucide:users" class="w-5 h-5 text-gray-400" />
          </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm font-medium text-gray-600">Moderadores</span>
            <Icon icon="lucide:shield" class="w-5 h-5 text-blue-400" />
          </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          <div class="flex items-center justify-between mb-2">
            ...
            <Icon icon="lucide:crown" class="w-5 h-5 text-purple-400" />
          </div>
