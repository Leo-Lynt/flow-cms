...
<template>
  <AppLayout>
    ...
    <!-- Messages -->
    <div v-if="message" class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center">
      <Icon icon="lucide:check-circle" class="w-5 h-5 mr-2" />
      {{ message }}
    </div>

    <div v-if="error" class="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:col-span-1">
        ...
        <!-- Stats Card -->
        <div v-if="stats" class="mt-6 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-lg p-4">
          <h4 class="text-sm font-semibold text-gray-700 mb-3">Account Overview</h4>
          <div class="space-y-2 text-sm">
            <div class="flex justify-between">
              <span class="text-gray-600">Flows:</span>
            ...
            <div v-if="show2FASetup" class="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxlength="6"
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-2xl tracking-widest"
                />
              </div>
              ...
              <div class="flex space-x-3">
                <button
                  ...
                  class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center space-x-2"
                >
            ...
            <div v-if="show2FADisable" class="space-y-4">
              ...
              <div class="flex space-x-3">
                <button
                  ...
                  :disabled="saving"
                  class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50 flex items-center space-x-2"
                >
