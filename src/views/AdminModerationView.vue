  ...
  <AppLayout>
    <div class="max-w-7xl mx-auto">
      ...
      <div v-if="activeTab === 'pending'" class="space-y-4">
        ...
        <div v-else-if="pendingFlows.length === 0" class="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <div class="flex items-start justify-between">
            ...
            <div class="flex flex-col gap-2 ml-6">
              <button
                ...
                class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-2 whitespace-nowrap"
              >
      ...
      <div v-if="activeTab === 'allFlows'" class="space-y-6">
        ...
        <div v-else-if="allFlows.length === 0" class="bg-white rounded-lg border border-gray-200 p-12 text-center">
      ...
      <div v-if="activeTab === 'reports'" class="space-y-4">
        ...
        <div v-else-if="reports.length === 0" class="bg-white rounded-lg border border-gray-200 p-12 text-center">
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <button
              ...
              class="ml-6 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 whitespace-nowrap"
            >
